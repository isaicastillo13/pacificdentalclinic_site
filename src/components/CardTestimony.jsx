...
function CardTestimonios({ image, name, experience, patientOf}) {
    return (
        <div className='flex flex-col items-center justify-center p-5 gap-9 bg-neutralsligth'>
            ...
            <p>Estaba inseguro con mi sonrisa, pero desde que comencé mi tratamiento con Invisalign, he notado un cambio increíble. El proceso ha sido cómodo y los resultados han superado mis expectativas. El equipo fue muy atento en cada etapa.</p>
