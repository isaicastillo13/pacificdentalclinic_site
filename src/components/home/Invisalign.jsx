    ...
    <section className="flex flex-col">
      ...
      >
        ...
        >
          ...
          "
          >
            <b className="font-bold">Invisalign Panamá:</b> La Solución Perfecta
            para una Sonrisa Discreta
          </h2>
          <img
            src={invisalignCase}
        ...
        >
          ...
          >
            ...
            tratamiento es personalizado y se basa en tecnología avanzada, lo
            que garantiza resultados efectivos y rápidos. Cada vez más panameños
          ...
          >
            ...
            transparentes que, mediante un diseño digital personalizado, guían
            los dientes hacia su posición ideal. A lo largo del tratamiento se
            utilizan varias férulas, que se cambian cada una o dos semanas para
            ajustar progresivamente el movimiento dental conforme avanza el
            proceso.
          </p>
        </div>
      </div>
