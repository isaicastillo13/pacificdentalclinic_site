      ...
      <section className="">
        ...
        <div className="w-full px-4 py-10 mx-auto max-w-7xl">
          <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 md:grid-cols-3 place-items-center">
            ...
            <Card
              img={imgPasquale}
              name="Dr. Pasquale Calvosa"
              specialization="Rehabilitador Bucal"
            />
            <Card
              img={imgMonica}
              name="Dra. Monica Shedden"
              specialization="Periodoncista / Implantologa"
            />
            <Card
              img={imgMoises}
              name="Dr. Moises Lukowiecki"
              specialization="Endodoncista"
            />
            <Card
              img={imgKira}
              name="Dra. Kira Singh"
              specialization="Odontopediatra"
            />
            <Card
              img={imgCarlos}
              name="Dr. Carlos Salazar"
              specialization="Ortodoncista"
            />
          </div>
        </div>
