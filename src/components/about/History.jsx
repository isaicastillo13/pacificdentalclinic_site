...
function History() {
return (
    <section className="relative h-screen overflow-hidden p-10">
        <div className="flex flex-col items-center justify-center">
            <img
                src={logoClinicaDark}
                alt="Logo Clínica"
                className="w-56 h-24 left-[640px] top-[31px]"
            />
            <div className="mt-10 flex flex-col items-center justify-center gap-8 md:flex-row">
                <div className="flex flex-col items-center justify-center gap-8">
                    <h2 className="w-[730px] text-[32px] text-primary md:text-[40px] lg:text-[54px]">
                        <span className="font-bold text-zinc-700">Nuestra Historia</span>
                        <span>, Tu Confianza</span>
                    </h2>
                    <p className="w-11/12 text-justify text-[10px] font-light text-primary md:text-xs lg:text-base">
                ...
                <img
                    src={fotoVieja}
                    alt="Foto Antigua"
                    className="h-auto w-1/3 rounded-[20px] bg-blend-luminosity grayscale"
                />
            </div>
        </div>
    </section>
